    ...
    <footer className="bg-blue-600 p-4 text-white mt-8">
      <div className="container mx-auto text-center">
        ...
        <div className="flex justify-center mt-4 space-x-4">
          {/* Facebook */}
          <Link href="https://www.facebook.com" target="_blank" className="text-gray-300 hover:text-white transition duration-200">
          ...
          {/* Instagram */}
          <Link href="https://www.instagram.com" target="_blank" className="text-gray-300 hover:text-white transition duration-200">
            <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
          ...
          {/* Twitter (X) */}
          <Link href="https://www.twitter.com" target="_blank" className="text-gray-300 hover:text-white transition duration-200">
            <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
